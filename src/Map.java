...
public class Map {
    ...
    public final void initUI() throws Exception {
        ...
        int etendue = 1;
String urlstring="https://img.freepik.com/premium-vector/france-map-background-with-states-france-map-isolated-white-background-vector-illustration_1003415-27.jpg";        URL url = new URL(urlstring);
    ...
    public void mouseDragged(MouseEvent e) {
        // Code à exécuter lorsque la souris est déplacée en maintenant un bouton enfoncé
    }

    @Override
    public void mouseMoved(MouseEvent e) {
        // Code à exécuter lorsque la souris est déplacée sans maintenir de bouton enfoncé
    }
}
...
class MouseClickListener implements MouseMotionListener, MouseListener {
    ...
    public void mouseClicked(MouseEvent e) {
        System.out.println("get out of china");
